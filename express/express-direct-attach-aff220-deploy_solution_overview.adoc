...
image:express-direct-attach-aff220-deploy_image2.png["FlexPod Express, FlexPod Datacenter 및 FlexPod Select 솔루션을 비교하는 다이어그램"]
...
image:express-direct-attach-aff220-deploy_image3.png["FlexPod Express 서버, Nexus 스위치 및 AFF 스토리지 케이블링을 관리, 데이터, IP, 클러스터 인터커넥트 및 vPC 피어 네트워크에 사용하는 구성을 보여주는 다이어그램입니다."]
