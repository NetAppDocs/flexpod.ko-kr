...
+
image:express-c-series-aff220-deploy_image6.png["두 개의 HA 쌍 노드 및 라이선스에 대한 System Manager 안내 설정 클러스터 구성 필드의 스크린샷"]
...
+
image:express-c-series-aff220-deploy_image7.png["AutoSupport 및 이벤트 알림 필드가 있는 OnCommand System Manager 지원 설정의 스크린샷"]
