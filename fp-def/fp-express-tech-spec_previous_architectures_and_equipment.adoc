...
* link:https://www.netapp.com/pdf.html?item=/media/12441-nva-0016-flexpod-express.pdf["FlexPod Express with Cisco UCS C-Series 및 NetApp FAS2500 시리즈"^]
* link:https://www.netapp.com/pdf.html?item=/media/12442-nva-0020-deploy.pdf["VMware vSphere 6.0을 사용하는 FlexPod Express: 소규모 및 중간 규모 구성"^]
* link:https://www.netapp.com/pdf.html?item=/media/12443-nva-0017-flexpod-express.pdf["VMware vSphere 6.0을 사용하는 FlexPod Express: 대규모 구성"^]
* link:https://www.netapp.com/pdf.html?item=/media/12444-nva-0021-deploypdf.pdf["Microsoft Windows Server 2012 R2 Hyper-V를 사용하는 FlexPod Express: 소규모 및 중간 규모 구성"^]
* link:https://www.netapp.com/pdf.html?item=/media/12445-tr-4350.pdf["Microsoft Windows Server 2012 R2 Hyper-V를 사용하는 FlexPod Express: 대규모 구성"^]
