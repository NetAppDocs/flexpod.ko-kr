...
NetApp ONTAP 소프트웨어는 AFF 및 FAS 스토리지 시스템에서 실행되는 운영 체제입니다. ONTAP는 무중단 운영, 무중단 업그레이드 및 민첩한 데이터 인프라를 지원하는 확장성이 뛰어난 스토리지 아키텍처를 제공합니다.
...
E-시리즈 SANtricity 소프트웨어는 E-시리즈 스토리지 시스템에서 실행되는 운영 체제입니다. SANtricity는 다양한 애플리케이션 요구 사항을 충족하는 매우 유연한 시스템을 제공하며, 내장된 고가용성과 광범위한 데이터 보호 기능을 제공합니다.

자세한 내용은 http://www.netapp.com/us/products/platform-os/santricity/index.aspx["SANtricity 제품 페이지"^]를 참조하십시오.
