...
image:express-c-series-c190-design_image1.png["FlexPod Express 부서별 배포와 FlexPod Datacenter 미션 크리티컬 워크로드를 비교하는 다이어그램"]
...
image:express-c-series-c190-design_image2.png["FlexPod Express 스토리지, 스위치 및 서버 하드웨어 옵션을 보여주는 다이어그램"]
...
image:express-c-series-c190-design_image3.png["FlexPod Express 스위치, C220 M5 서버 및 AFF C190 스토리지 연결을 보여주는 다이어그램"]
