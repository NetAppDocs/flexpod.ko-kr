...
image:express-c-series-aff220-deploy_image3.png["FlexPod Express, Datacenter 및 Select 솔루션, 대상 및 인프라 구성 요소를 비교하는 다이어그램"]
...
image:express-c-series-aff220-deploy_image4.png["Cisco Nexus 3172P 스위치, UCS C220 M5 서버 및 AFF A220 스토리지 연결을 보여주는 다이어그램"]
