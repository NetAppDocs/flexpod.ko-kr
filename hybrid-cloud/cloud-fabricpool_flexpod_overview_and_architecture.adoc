...
image:cloud-fabricpool_image2.png["FlexPod 스토리지, Cisco Nexus 및 MDS 스위치, 그리고 Cisco UCS 제품군의 연결 지침을 보여주는 다이어그램입니다."]
...
image:cloud-fabricpool_image3.png["Cisco UCS, Nexus 93180YC-EX, AFF A300 및 MDS 9148S 연결을 보여주는 다이어그램"]
