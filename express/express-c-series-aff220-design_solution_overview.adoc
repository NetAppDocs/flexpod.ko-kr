...
image:express-c-series-aff220-design_image3.png["FlexPod Express 스토리지, 스위칭 및 컴퓨팅 하드웨어 제품군과 구성 옵션을 보여주는 다이어그램"]
...
image:express-c-series-aff220-design_image4.png["Cisco Nexus 3172P 스위치, UCS C220 M5 서버 및 AFF A220 스토리지 연결을 보여주는 다이어그램"]
