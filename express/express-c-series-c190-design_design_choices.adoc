...
image:express-c-series-c190-design_image4.png["AFF C190 SFP+ 모듈용 UTA 2 포트가 있는 두 대의 AFF C190 컨트롤러의 후면도를 보여주는 다이어그램"]

다음 그림은 기존 RJ-45 이더넷 케이블을 통한 연결을 위한 10GBASE-T 포트를 보여줍니다.

image:express-c-series-c190-design_image5.png["10GBASE-T RJ-45 포트가 있는 AFF C190 시스템의 후면 패널을 보여주는 다이어그램"]
...
AFF C190 하드웨어 시스템에 대한 전체 정보는  https://docs.netapp.com/us-en/ontap-systems/c190/install-setup.html["NetApp AFF C190 설명서"^]을 참조하십시오.
...
image:express-c-series-c190-design_image6.png["여러 개의 4KB 논리 블록이 하나의 4KB 물리 블록으로 압축된 것을 보여주는 다이어그램"]
...
image:express-c-series-c190-design_image7.png["48개의 SFP+ 포트와 6개의 QSFP28 포트를 갖춘 Cisco Nexus 31108PC-V 스위치의 정면 모습"]
...
image:express-c-series-c190-design_image8.png["듀얼 드라이브 베이와 Cisco 브랜드 로고가 있는 Cisco UCS C220 M5 랙 서버의 정면 모습"]
...
image:express-c-series-c190-design_image9.png["4개의 SFP28 포트와 냉각 팬이 장착된 Cisco UCS VIC 1457 어댑터의 스크린샷"]
...
image:express-c-series-c190-design_image10.png["VMware ESXi 6.7 U2 호스트에서 FlexPod 및 iSCSI 부팅 vSwitches에 연결된 4개의 vNIC를 보여주는 다이어그램"]
