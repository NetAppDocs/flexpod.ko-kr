...
image:flexpod-genomics-image6.png["Cisco UCS, Nexus, MDS 및 NetApp AFF A700 연결을 지원하는 Genomics용 FlexPod를 보여주는 다이어그램"]

다음 다이어그램은 FlexPod 케이블 연결 세부 정보를 보여 줍니다.

image:flexpod-genomics-image7.png["UCS, Nexus, NetApp AFF 및 MDS 스위치 간의 Genomics용 FlexPod 케이블 연결을 보여주는 다이어그램"]
