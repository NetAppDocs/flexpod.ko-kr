...
이중화된 AFF C190, AFF A220 또는 FAS2750 시리즈 컨트롤러는 FlexPod Express 아키텍처에서 필요합니다. 이러한 컨트롤러는 ONTAP 소프트웨어를 실행합니다. 스토리지 컨트롤러를 주문할 때 원하는 소프트웨어 버전을 컨트롤러에 미리 설치할 수 있습니다. ONTAP의 경우, 클러스터는 한 쌍의 클러스터 인터커넥트 스위치를 사용하거나 스위치가 없는 클러스터 구성으로 배포할 수 있습니다.

다음 표에 나열된 부품 번호는 빈 컨트롤러용입니다. 선택한 스토리지 플랫폼에 따라 다양한 옵션과 구성이 가능합니다. 이러한 추가 구성 요소에 대한 자세한 내용은 영업 담당자에게 문의하십시오.
...
다음 표는 NetApp FAS10GbE 어댑터 옵션을 나열합니다.
...
[NOTE]
====
FAS2500 및 2600 시리즈 스토리지 시스템에는 10GbE 포트가 내장되어 있습니다.

NetApp X1117A 어댑터는 FAS8020 스토리지 시스템용입니다.
...
[NOTE]
====
E2824 시리즈 스토리지 시스템에는 10GbE 포트가 내장되어 있습니다.

10GbE iSCSI/16Gb FC 4포트 호스트 인터페이스 카드(HIC)는 포트 밀도를 높이는 데 사용할 수 있습니다.

====
온보드 포트와 HIC는 SANtricity OS에서 활성화된 기능에 따라 iSCSI 어댑터 또는 FC 어댑터로 작동할 수 있습니다.

지원되는 어댑터 옵션에 대한 자세한 내용은  https://hwu.netapp.com/Adapter/Index["NetApp Hardware Universe를 참조하십시오"^]의 어댑터 섹션을 참조하십시오.
...
스토리지 컨트롤러에는 최소 하나 이상의 NetApp 디스크 쉘프가 필요합니다. 선택한 NetApp 쉘프 유형에 따라 해당 쉘프에서 사용할 수 있는 드라이브 유형이 결정됩니다.

FAS2700 및 FAS2600 시리즈 컨트롤러는 동일한 섀시 내에 이중 스토리지 컨트롤러와 디스크를 포함하는 구성으로 제공됩니다. 이 구성은 SATA 또는 SAS 드라이브와 함께 제공되므로 성능이나 용량 요구 사항에 따라 더 많은 스핀들이 필요한 경우가 아니면 추가 외장 디스크 쉘프가 필요하지 않습니다.

[NOTE]
====
모든 디스크 쉘프 부품 번호는 AC 전원 공급 장치 2개가 포함된 빈 쉘프용입니다. 추가 부품 번호는 담당 영업 사원에게 문의하십시오.

디스크 드라이브 부품 번호는 구매하려는 디스크의 크기와 폼 팩터에 따라 다릅니다. 자세한 부품 번호는 영업 담당자에게 문의하십시오.
...
섀시에 드라이브가 없는 스토리지 컨트롤러에는 최소 하나의 NetApp 디스크 쉘프가 필요합니다. 선택한 NetApp 쉘프 유형에 따라 해당 쉘프에서 사용할 수 있는 드라이브 유형이 결정됩니다.

E2800 시리즈 컨트롤러는 지원되는 디스크 쉘프 내에 수용된 이중 스토리지 컨트롤러와 디스크를 포함하는 구성으로 제공됩니다. 이 구성은 SSD 또는 SAS 드라이브와 함께 제공됩니다.


NOTE: 디스크 드라이브 부품 번호는 구매하려는 디스크의 크기와 폼 팩터에 따라 다릅니다. 자세한 부품 번호는 영업 담당자에게 문의하십시오.

다음 표는 NetApp 디스크 쉘프 옵션과 각 쉘프 유형에서 지원되는 드라이브 목록을 보여줍니다. 이 정보는 NetApp Hardware Universe에서 확인할 수 있습니다. Hardware Universe 링크를 클릭하고 사용 중인 ONTAP 버전을 선택한 다음 쉘프 유형을 선택하십시오. 쉘프 이미지 아래에서 지원되는 드라이브를 클릭하면 특정 ONTAP 버전 및 디스크 쉘프에서 지원되는 드라이브를 확인할 수 있습니다.
...
다음 표는 NetApp FAS 소프트웨어 라이선스 옵션을 보여줍니다.

|===
| NetApp 소프트웨어 라이센스 | 부품 번호 | 기술 사양 


| 기본 클러스터 라이선스 2+| 라이센스 정보에 대한 자세한 내용은 NetApp 세일즈 팀에 문의하십시오. 
|===


=== E-Series 스토리지

다음 표는 E-Series 소프트웨어 라이선스 옵션을 보여줍니다.

|===
| NetApp 소프트웨어 라이센스 | 부품 번호 | 기술 사양 


| 기본 사양 2.2+| 라이센스 정보에 대한 자세한 내용은 NetApp 세일즈 팀에 문의하십시오. 
...
다음 표는 NetApp FAS에 대한 NetApp 지원 라이선스 옵션을 나열합니다.
...
다음 표는 E-Series 스토리지에 대한 NetApp 지원 라이선스 옵션을 나열합니다.

|===
| NetApp Support 라이센스 | 부품 번호 | 기술 사양 


| 하드웨어 지원 Premium 4시간 현장 방문, 기간: 36개월 | SVC-O2-4HR-E .3+| link:https://www.netapp.com/pdf.html?item=/media/19784-ds-3873.pdf["https://www.netapp.com/pdf.html?item=/media/19784-ds-3873.pdf"] 
