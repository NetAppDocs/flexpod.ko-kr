...
+
image:express-c-series-aff220-deploy_image8.png["CIMC 설정을 위해 F8 키를 누르도록 사용자에게 안내하는 Cisco 서버 부팅 화면의 스크린샷"]
...
*** 없음: [X]
+
image:express-c-series-aff220-deploy_image9.png["IPv4 설정이 되어 있고 NIC 이중화가 선택되지 않은 Cisco IMC NIC 속성의 스크린샷"]
...
+
image:express-c-series-aff220-deploy_image10.png["일반 속성 및 포트 설정을 보여주는 Cisco IMC 구성 유틸리티의 스크린샷"]
...
+
image:express-c-series-aff220-deploy_image11.png["부팅 순서 구성이 선택된 Cisco 통합 관리 컨트롤러 BIOS 설정의 스크린샷"]
...
+
image:express-c-series-aff220-deploy_image12.png["KVM-MAPPED-DVD, iSCSI-A 및 iSCSI-B가 활성화된 고급 부팅 순서 구성의 스크린샷"]
...
+
image:express-c-series-aff220-deploy_image13.png["PCIe 슬롯 1과 슬롯 2의 옵션 ROM이 비활성화된 CIMC BIOS 설정을 보여주는 스크린샷"]
...
** PXE 부팅 활성화: 확인
+
image:express-c-series-aff220-deploy_image14.png["MTU 9000, VLAN 3439, 트렁크 모드 및 PXE 부팅이 활성화된 iSCSI-vNIC-A 설정을 보여주는 스크린샷"]
...
+
image:express-c-series-aff220-deploy_image15.png["vNIC 탭에서 iSCSI 부팅 속성을 확장하여 iSCSI-vNIC-A를 선택한 모습을 보여주는 스크린샷"]
...
+
image:express-c-series-aff220-deploy_image16.png["이니시에이터 이름, IP 주소, 서브넷 마스크 및 게이트웨이 필드를 보여주는 Cisco UCS iSCSI 부팅 속성의 스크린샷"]
...
+
image:express-c-series-aff220-deploy_image17.png["기본 및 보조 NetApp 타겟을 사용한 iSCSI vNIC 이니시에이터 설정을 보여주는 스크린샷"]
...
+
image:express-c-series-aff220-deploy_image18.png["eth0, eth1 및 두 개의 iSCSI vNIC가 나열된 Cisco VIC vNIC 탭의 스크린샷"]

. eth0 을 선택하고 속성 을 클릭합니다.
. MTU를 9000으로 설정합니다. 변경 내용 저장 을 클릭합니다.
+
image:express-c-series-aff220-deploy_image19.png["MTU 필드가 9000으로 설정된 Cisco VIC eth0 vNIC 속성의 스크린샷"]

. eth1에 대해 3단계와 4단계를 반복하여 업링크 포트가 eth1에 대해 "1"로 설정되어 있는지 확인합니다.
+
image:express-c-series-aff220-deploy_image20.png["eth0 및 eth1 MTU가 9000으로 설정되고 업링크 포트 0과 1이 표시된 vNIC 탭을 보여주는 스크린샷"]
