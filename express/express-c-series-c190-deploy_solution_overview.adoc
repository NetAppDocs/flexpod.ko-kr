...
image:express-c-series-c190-deploy_image1.png["FlexPod Express 및 FlexPod Datacenter 포트폴리오 옵션과 사용 사례를 보여주는 다이어그램"]
...
image:express-c-series-c190-deploy_image2.png["FlexPod Express 스위치, C220 M5 서버 및 AFF C190 스토리지 연결을 보여주는 다이어그램"]
