...
. 로 이동 https://www.netapp.com/data-infrastructure-insights/["https://www.netapp.com/data-infrastructure-insights/"^]
...
+
image:cloud-insights_image3.png["vSphere 클러스터 작업 중 새 가상 머신이 강조 표시된 vSphere 컨텍스트 메뉴"]
...
+
image:cloud-insights_image4.png["Linux와 Red Hat Enterprise Linux 7(64비트)이 선택된 게스트 운영 체제 선택 마법사의 스크린샷"]
...
+
image:cloud-insights_image5.png["CPU, 메모리, 디스크, 네트워크 및 CD/DVD 드라이브가 구성된 VMware 하드웨어 설정 사용자 지정 화면의 스크린샷"]
...
+
image:cloud-insights_image6.png["Install이 선택된 Red Hat Enterprise Linux 7.6 부팅 메뉴의 스크린샷"]
...
+
image:cloud-insights_image7.png["선택된 100GiB VMware 가상 디스크와 수동 파티셔닝 옵션을 보여주는 스크린샷"]
...
+
image:cloud-insights_image8.png["25GiB /opt/netapp 및 /var/log/netapp 볼륨을 사용한 Red Hat Enterprise Linux 수동 파티셔닝 스크린샷"]
...
+
image:cloud-insights_image9.png["이더넷이 활성화되고 호스트 이름이 입력된 Red Hat Enterprise Linux 네트워크 및 호스트 이름 화면의 스크린샷"]
...
+
image:cloud-insights_image10.png["Red Hat Enterprise Linux 설치 완료 화면의 스크린샷으로, 재부팅 버튼이 있습니다."]

. 시스템이 재부팅된 후 서버에 로그인하여 Red Hat 서브스크립션 관리자에 등록하십시오.
+
image:cloud-insights_image11.png["Netapp-AU 시스템에 대한 Red Hat Subscription Manager 등록이 성공적으로 완료되었음을 보여주는 터미널 화면입니다."]

. Red Hat Enterprise Linux에 사용 가능한 서브스크립션을 첨부하십시오.
+
image:cloud-insights_image12.png["Red Hat Enterprise Linux 구독이 성공적으로 연결되었음을 보여주는 터미널 화면"]
...
+
image:cloud-insights_image14.png["데이터 수집기 및 수집 장치 탭이 표시되고 수집 장치가 선택된 스크린샷"]

. 새 획득 장치를 생성하려면 오른쪽에 있는 버튼을 클릭합니다.
+
image:cloud-insights_image15.png["획득 유닛 추가 버튼과 필터 필드를 보여주는 스크린샷"]
...
+
image:cloud-insights_image16.png["Cloud Insights Linux Acquisition Unit 설치 지침 및 설치 프로그램 스니펫을 보여주는 스크린샷"]

. 프로비저닝된 Red Hat Enterprise Linux 시스템의 CLI에 스니펫을 붙여 넣고 Enter 를 클릭합니다.
+
image:cloud-insights_image17.png["Linux에 Cloud Insights 수집 장치를 설치하는 토큰 명령어를 보여주는 터미널 창"]

+
설치 프로그램이 압축된 패키지를 다운로드하고 설치를 시작합니다. 설치가 완료되면 획득 장치가 NetApp Cloud Insights에 등록되었다는 메시지가 표시됩니다.

+
image:cloud-insights_image18.png["NetApp Cloud Insights Acquisition Unit 설치 및 등록이 성공적으로 완료되었음을 보여주는 터미널 화면입니다."]
...
+
image:cloud-insights_image19.png["IP, 정상 상태 및 마지막 보고 시간을 표시하는 NetApp-AU Acquisition Unit 요약 스크린샷"]
...
+
image:cloud-insights_image20.png["데이터 수집기 추가 페이지에서 필터링된 ONTAP 데이터 수집기 옵션을 보여주는 스크린샷"]
...
+
image:cloud-insights_image21.png["유효한 ONTAP 자격 증명 및 수집 장치 설정이 포함된 수집기 구성 페이지의 스크린샷"]
...
+
image:cloud-insights_image22.png["FlexPod Datacenter 폴링 상태를 표시하는 Cloud Insights 데이터 수집기 행의 스크린샷"]
