...
다음 그림은 Cisco MDS를 사용하는 FC용 FlexPod 데이터센터를 보여줍니다.
...
ONTAP 구현에 대한 자세한 내용은 를 참조하십시오 https://www.netapp.com/pdf.html?item=/media/10681-tr4684pdf.pdf["TR-4684: NVMe로 최신 SAN 구현 및 구성"^].
