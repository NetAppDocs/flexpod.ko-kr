...
컨트롤러의 물리적 설치 절차를 따르십시오 https://docs.netapp.com/us-en/ontap-systems/a220/install-setup.html["AFF A220 문서"^].
...
| NTP 서버 A IP입니다 | +<< switch-a-ntp-ip >>+ 
...
[[cisco-ucs-manager-software-version-4-01b]]
...
+
image:express-direct-attach-aff220-deploy_image7.png["IP 주소, 서브넷, 게이트웨이 및 DNS 필드가 있는 IPv4 주소 블록 생성 대화 상자의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image8.png["NTP 서버가 10.1.156.4로 설정된 NTP 서버 추가 대화 상자의 스크린샷"]

. NTP 서버 추가를 클릭합니다.
. '<switch-b-ntp-ip>' 또는 <Nexus-B-mgmt-ip>'를 입력하고 확인을 클릭합니다. 확인 창에서 확인 을 클릭합니다.
+
image:express-direct-attach-aff220-deploy_image9.png["두 개의 NTP 서버가 나열되고 America/New_York 시간대가 선택된 Cisco UCS Manager NTP 설정 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image10.png["업링크 및 어플라이언스 스토리지 역할이 구성된 Fabric Interconnect A 이더넷 포트를 보여주는 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image11.png["네트워크 및 어플라이언스 스토리지 역할이 구성된 Fabric Interconnect B 이더넷 포트를 보여주는 스크린샷"]
...
. 다음 을 클릭합니다.
+
image:express-direct-attach-aff220-deploy_image12.png["ID가 1이고 이름이 vPC-13-Nexus로 입력된 포트 채널 생성 대화 상자의 스크린샷"]
...
. 공유 유형을 없음으로 둡니다.
+
image:express-direct-attach-aff220-deploy_image13.jpeg["NFS-VLAN과 VLAN ID 3170이 입력된 VLAN 생성 대화 상자의 스크린샷"]
...
. 확인을 클릭한 다음 확인을 다시 클릭하여 VLAN을 만듭니다.
+
image:express-direct-attach-aff220-deploy_image14.png["Cisco UCS Manager의 VLAN 이름 및 ID가 포함된 VLAN 테이블을 보여주는 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image15.png["CDP 및 LLDP 송수신이 활성화된 Enable_CDP 네트워크 제어 정책을 보여주는 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image16.png["CDP가 활성화되고 스토리지 VLAN이 선택된 상태의 어플라이언스 인터페이스 1/3 속성 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image17.png["iSCSI-B, NFS 및 네이티브 VLAN이 선택된 어플라이언스 인터페이스 1/3 VLAN 설정 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image18.png["Best Effort MTU가 9216으로 설정된 Cisco UCS Manager QoS 시스템 클래스 설정의 스크린샷"]
...
[[load-cisco-ucs-4-01b-firmware-images]]
...
+
image:express-direct-attach-aff220-deploy_image19.png["Blade Package 4.0(1b)B가 선택된 패키지 버전 수정 대화 상자의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image20.png["MAC 주소 00:25:B5:32:0A:00 및 크기 64를 포함하는 MAC 주소 블록 생성 대화 상자의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image21.png["접미사 ucs-host, 시작 번호 1, 크기 16으로 설정된 IQN 접미사 블록 생성 대화 상자의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image22.png["CDP 및 LLDP가 활성화된 네트워크 제어 정책 생성 대화 상자의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image23.png["No-Power-Cap 및 No Cap이 선택된 전력 제어 정책 만들기 대화 상자의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image24.png["Xeon 프로세서 아키텍처 및 CPU PID 필드가 있는 Cisco UCS Manager CPU/코어 검증 생성 대화 상자 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image25.png["VM 호스트 이름과 일관된 장치 이름 지정이 활성화된 BIOS 정책 생성 대화 상자의 스크린샷"]
...
** 프로세서 C7 보고서: 사용 안 함
+
image:express-direct-attach-aff220-deploy_image26.png["프로세서 C 상태 및 C1E가 비활성화된 BIOS 정책 프로세서 생성 탭의 스크린샷"]
...
** DRAM 클럭 제한: 성능
+
image:express-direct-attach-aff220-deploy_image27.png["BIOS 프로세서 옵션에서 Energy Performance 및 DRAM Clock Throttling이 성능으로 설정된 스크린샷"]
...
** LV DDR 모드: 성능 모드
+
image:express-direct-attach-aff220-deploy_image28.png["LV DDR 모드가 성능 모드로 설정된 BIOS 정책 생성 RAS 메모리 페이지의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image29.png["사용자 승인 및 다음 부팅 시에 적용이 선택된 Cisco UCS Manager 기본 유지 관리 정책의 스크린샷"]
...
. 확인 을 클릭합니다.
+
image:express-direct-attach-aff220-deploy_image30.png["패브릭 A의 vNIC_Template_A에 대한 Cisco UCS Manager vNIC 템플릿 속성 스크린샷"]
...
. 확인 을 클릭합니다.
+
image:express-direct-attach-aff220-deploy_image31.png["Cisco UCS Manager vNIC 템플릿 B 설정의 스크린샷(패브릭 B, MTU 9000, MAC 풀 B 선택됨)"]
...
. 확인 을 클릭합니다.
+
image:express-direct-attach-aff220-deploy_image32.png["패브릭 A, MTU 9000, MAC 풀 A56/64가 선택된 Site_01_iSCSI-A vNIC 템플릿의 스크린샷"]
...
. 확인 을 클릭합니다.
+
image:express-direct-attach-aff220-deploy_image33.png["MTU 9000을 사용하는 패브릭 B에 대한 Cisco UCS Manager vNIC 템플릿 Site_01_iSCSI-B 설정의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image34.png["vNIC_Template_A 및 VMWare 어댑터 정책을 사용하여 Site-01-vNIC-A에 대한 vNIC 수정 대화 상자를 보여 주는 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image35.png["VLAN 및 MAC 주소 설정이 포함된 Site-01-iSCSI-A의 iSCSI vNIC 수정 대화 상자 스크린샷"]
...
. 변경 내용 저장 을 클릭합니다.
+
image:express-direct-attach-aff220-deploy_image36.png["두 개의 iSCSI vNIC가 나열된 Site-01-iSCSIBoot LAN 연결 정책의 스크린샷"]
...
+
이 VMware ESXi 6.7U1 ISO 파일은 다음에서 다운로드할 수 있습니다 https://support.broadcom.com/group/ecx/downloads["Broadcom 지원 포털"^].
...
+
image:express-direct-attach-aff220-deploy_image37.png["HTTP ESXi 설치 프로그램 ISO 원격 파일 및 경로로 구성된 vMedia 마운트 생성 대화 상자의 스크린샷"]
...
. 확인 을 클릭하여 정책을 생성합니다.
+
image:express-direct-attach-aff220-deploy_image38.png["두 개의 iSCSI 부팅 항목이 구성된 Cisco UCS Manager 부팅 정책 Site-01-Fabric-A의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image39.png["이름, 업데이트 템플릿 및 UUID 풀 필드를 포함하는 서비스 프로필 템플릿 생성 마법사의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image40.png["iSCSI-Boot 연결 및 IQN_Pool이 선택된 서비스 프로필 템플릿 생성 네트워킹 설정의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image41.png["Boot-Fabric-A가 선택된 서비스 프로필 템플릿 서버 부팅 순서 생성 페이지의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image42.png["Infra-SVM 타겟 IQN, 별칭 및 작동 상태를 나열하는 iscsi show 명령 출력의 스크린샷"]

. IPv4 Address 필드에 iSCSI_lif_02a IP 주소를 입력합니다.
+
image:express-direct-attach-aff220-deploy_image43.png["IPv4 주소 192.168.10.62가 입력된 iSCSI 정적 타겟 생성 대화 상자의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image44.png["IPv4 주소 192.168.10.61 및 LUN ID 0을 사용하는 iSCSI 정적 타겟 생성 대화 상자의 스크린샷"]

. 확인 을 클릭하여 iSCSI 정적 대상을 추가합니다.
+
image:express-direct-attach-aff220-deploy_image45.png["iSCSI 정적 대상 인터페이스가 선택된 iSCSI 부팅 매개변수 설정 대화 상자의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image46.png["IPv4 주소가 192.168.20.62로 설정된 iSCSI 정적 타겟 생성 대화 상자의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image47.png["IPv4 주소 192.168.20.61 및 LUN ID 0을 사용하는 iSCSI 정적 타겟 생성 대화 상자의 스크린샷"]

. 확인 을 클릭하여 iSCSI 정적 대상을 추가합니다.
+
image:express-direct-attach-aff220-deploy_image48.png["iSCSI 부팅 매개변수 설정에서 두 개의 iSCSI 정적 대상 인터페이스가 선택된 것을 보여주는 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image49.png["기본 정책이 선택된 서비스 프로필 템플릿 유지 관리 정책 생성 단계의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image50.png["Infra-Pool, 다운 전원 상태 및 기본 펌웨어 패키지가 선택된 서비스 프로필 템플릿 서버 할당 생성 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image51.png["VM-Host BIOS 및 No-Power-Cap이 선택된 서비스 프로필 템플릿 생성 운영 정책 페이지의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image52.png["접두사 Site-01-Infra-0, 번호 2, 루트 조직이 포함된 템플릿에서 서비스 프로필 생성 대화 상자의 스크린샷"]
...
. Broadcom 지원 포털 다운로드 사이트에 로그인하세요: https://support.broadcom.com/group/ecx/downloads["https://support.broadcom.com/group/ecx/downloads"^].
. Broadcom 사용자 ID와 비밀번호가 필요합니다. VMware vSphere Hypervisor(ESXi) 사용자 지정 ISO를 찾으십시오.
. Cisco ESXi 6.7U1 설치 CD용 Cisco 사용자 지정 이미지를 다운로드하십시오.
...
. Enter 키를 누릅니다.
+
image:express-direct-attach-aff220-deploy_image53.png["vmnic0 및 vmnic1이 선택되고 연결된 ESXi 네트워크 어댑터 화면의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image54.png["VMkernel 어댑터와 두 개의 물리적 어댑터를 포함한 vSwitch0의 세부 정보 및 토폴로지를 보여주는 스크린샷"]

. VMkernel NIC 탭을 선택하여 구성된 가상 어댑터를 확인합니다. 나열된 어댑터는 다음 예와 비슷해야 합니다.
+
image:express-direct-attach-aff220-deploy_image55.png["5개의 VMkernel 어댑터와 해당 포트 그룹이 나열된 ESXi VMkernel NIC 탭의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image56.png["iSCSI 소프트웨어 어댑터 vmhba64가 선택된 ESXi 스토리지 어댑터 탭의 스크린샷"]
...
. 구성 저장 을 클릭합니다.
+
image:express-direct-attach-aff220-deploy_image57.png["포트 3260에 있는 4개의 동적 및 정적 iSCSI 타겟을 보여주는 iSCSI 구성 대화 상자의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image58.png["생성 유형으로 NFS 데이터 저장소 마운트가 선택된 새 데이터 저장소 마법사의 스크린샷"]
...
.. 다음 을 클릭합니다.
+
image:express-direct-attach-aff220-deploy_image59.png["infra_datastore_1 및 NFS 서버 192.168.104.3이 표시된 NFS 마운트 세부 정보 제공 페이지의 스크린샷"]
...
. 마침 을 클릭합니다. 이제 데이터 저장소가 데이터 저장소 목록에 표시됩니다.
+
image:express-direct-attach-aff220-deploy_image60.jpeg["infra_datastore_2가 NFS 데이터스토어로 마운트된 것을 보여주는 ESXi 스토리지 데이터스토어 목록의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image61.png["NTP가 활성화되고 두 개의 NTP 서버 주소가 입력된 시간 구성 편집 대화 상자의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image62.png["스왑 설정 및 편집 설정을 보여주는 VMware ESXi 시스템 스왑 관리 페이지의 스크린샷"]

. 설정 편집 을 클릭합니다. Datastore 옵션에서 infra_swap을 선택합니다.
+
image:express-direct-attach-aff220-deploy_image63.png["infra_swap 데이터스토어가 선택되고 저장 및 취소 버튼이 있는 스왑 구성 편집 대화 상자의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image64.png["Get vCenter Server 버튼이 강조 표시된 ESXi 호스트 탐색기의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image65.png["Embedded Platform Services Controller가 선택된 vCenter Server Appliance 설치 프로그램의 배포 유형 선택 페이지 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image66.png["ESXi 호스트 자격 증명이 입력된 VCenter Server Appliance Installer 어플라이언스 배포 대상 페이지의 스크린샷"]

. VCSA를 VM 이름으로 입력하고 VCSA에 사용할 루트 암호를 입력하여 어플라이언스 VM을 설정합니다. 다음 을 클릭합니다.
+
image:express-direct-attach-aff220-deploy_image67.png["VM 이름 및 루트 암호 필드가 있는 vCenter Server Appliance 설치 프로그램 어플라이언스 VM 설정 페이지의 스크린샷"]

. 환경에 가장 적합한 구축 크기를 선택합니다. 다음 을 클릭합니다.
+
image:express-direct-attach-aff220-deploy_image68.png["Tiny가 선택된 vCenter Server Appliance 설치 프로그램의 배포 크기 선택 페이지 스크린샷"]

. 'infra_datastore_1' 데이터 저장소를 선택합니다. 다음 을 클릭합니다.
+
image:express-direct-attach-aff220-deploy_image69.png["세 개의 데이터스토어 중 infra_datastore_1이 나열된 vCenter Server Appliance 설치 프로그램 데이터스토어 선택 페이지의 스크린샷"]
...
.. DNS 서버를 입력합니다.
+
image:express-direct-attach-aff220-deploy_image70.png["고정 IPv4 세부 정보가 포함된 vCenter Server Appliance 설치 프로그램 네트워크 설정 구성 페이지의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image71.png["1단계 vCenter Server 배포가 성공적으로 완료되었고 계속 버튼이 표시된 스크린샷"]
...
. 확인 을 클릭합니다.
+
image:express-direct-attach-aff220-deploy_image72.png["Express 클러스터에 대해 DRS 및 vSphere HA가 활성화된 새 클러스터 대화 상자의 스크린샷"]
...
+
image:express-direct-attach-aff220-deploy_image73.png["호스트 추가가 선택된 Express 클러스터의 vSphere Client 작업 메뉴 스크린샷"]
