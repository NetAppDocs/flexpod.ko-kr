...
이 하이브리드 클라우드 솔루션은 정의된 대로 지원되는 소프트웨어, 펌웨어 및 하드웨어 버전을 실행하는 모든 FlexPod 환경으로 확장될 수 있습니다.link:http://support.netapp.com/matrix/["NetApp 상호 운용성 매트릭스 툴"^] ,link:https://ucshcltool.cloudapps.cisco.com/public/["UCS 하드웨어 및 소프트웨어 호환성"^] , 그리고link:https://www.vmware.com/resources/compatibility/search.php["VMware 호환성 가이드 를 참조하십시오"^] .
