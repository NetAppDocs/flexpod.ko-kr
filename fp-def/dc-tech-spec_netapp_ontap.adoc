...
[role="lead"]
NetApp ONTAP 소프트웨어는 모든 NetApp FAS, AFF 및 AFF All SAN Array(ASA) 시스템에 설치됩니다. FlexPod는 ONTAP 소프트웨어로 검증되어 중단 없는 운영, 중단 없는 업그레이드 및 민첩한 데이터 인프라를 지원하는 확장성이 뛰어난 스토리지 아키텍처를 제공합니다.
