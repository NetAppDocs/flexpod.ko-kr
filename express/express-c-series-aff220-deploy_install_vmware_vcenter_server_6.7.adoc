...
+
image:express-c-series-aff220-deploy_image41.png["Get vCenter Server 버튼이 강조 표시된 VMware ESXi 호스트 페이지의 스크린샷"]
...
+
image:express-c-series-aff220-deploy_image42.png["Embedded Platform Services Controller가 선택된 vCenter Server Appliance 배포 유형 선택 스크린샷"]
...
+
image:express-c-series-aff220-deploy_image43.png["ESXi 호스트, 포트, 루트 사용자 및 암호 필드가 있는 vCenter Server 어플라이언스 배포 대상 페이지의 스크린샷"]

. VCSA에 사용할 VM 이름과 루트 암호를 VCSA로 입력하여 어플라이언스 VM을 설정합니다.
+
image:express-c-series-aff220-deploy_image44.png["VM 이름 및 루트 암호 입력란이 있는 어플라이언스 VM 설정 페이지의 스크린샷"]

. 환경에 가장 적합한 구축 크기를 선택합니다. 다음 을 클릭합니다.
+
image:express-c-series-aff220-deploy_image45.png["Tiny 및 Default 스토리지가 선택된 vCenter Server 배포 크기 페이지의 스크린샷"]

. infra_datastore_1 데이터 저장소를 선택합니다. 다음 을 클릭합니다.
+
image:express-c-series-aff220-deploy_image46.png["infra_datastore_1이 선택된 vCenter Server 설치 프로그램의 데이터 저장소 선택 페이지 스크린샷"]
...
+
image:express-c-series-aff220-deploy_image47.png["고정 IPv4 필드가 채워진 vCenter Server Appliance 설치 프로그램의 네트워크 설정 구성 스크린샷"]
...
+
image:express-c-series-aff220-deploy_image48.png["다음 버튼이 있는 vCenter Server Appliance 2단계 소개 페이지의 스크린샷"]
