...
Intersight 라이선스 및 각 라이선스에서 지원되는 기능에 대한 자세한 내용은 https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["여기"^]에서 확인할 수 있습니다.
...
Intersight Assist를 Intersight에 등록한 후에는 Intersight Assist를 통한 등록 옵션을 사용하여 엔드포인트 장치를 등록할 수 있습니다. 자세한 내용은 https://intersight.com/help/saas/getting_started/overview["시작하기"^]을 참조하십시오.
