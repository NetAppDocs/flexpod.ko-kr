...
AFF A220 하드웨어 시스템에 대한 자세한 내용은  https://www.netapp.com/aff-a-series/["AFF A 시리즈 홈 페이지"^]을 참조하십시오.
...
image:express-c-series-aff220-design_image5.png["여러 개의 4KB 논리 블록이 하나의 4KB 물리 블록으로 압축된 것을 보여주는 다이어그램"]
...
image:express-c-series-aff220-design_image6.png["디스크가 루트, 컨트롤러 1, 컨트롤러 2 파티션으로 분할된 것을 보여주는 다이어그램"]

다음은 FlexPod Express 솔루션을 보완하는 몇 가지 주요 기능입니다. ONTAP 9.4의 추가 기능 및 성능에 대한 자세한 내용은 https://www.netapp.com/pdf.html?item=/media/7413-ds-3231-ontap-unified-data-storage-management.pdf["ONTAP 9 데이터 관리 소프트웨어 데이터시트입니다"^]을 참조하십시오. 또한 ONTAP 9.4를 포함하도록 업데이트된 NetApp http://docs.netapp.com/ontap-9/index.jsp["ONTAP 9 문서 센터"^]도 참조하십시오.
...
image:express-c-series-aff220-design_image7.png["Cisco Nexus 3172 스위치의 네트워크 포트가 있는 전면 모습을 보여주는 스크린샷"]
...
image:express-c-series-aff220-design_image8.png["듀얼 드라이브 베이와 Cisco 브랜드 로고가 있는 Cisco UCS C220 M5 랙 서버의 정면 모습"]
...
image:express-c-series-aff220-design_image9.png["듀얼 QSFP+ 포트와 냉각 팬이 장착된 Cisco UCS VIC 1387 어댑터 카드"]
...
image:express-c-series-aff220-design_image10.png["Cisco CVR-QSFP-SFP10G QSFP-to-SFP 어댑터 모듈 사진"]
