...
. 확인 을 클릭합니다.
+
image:express-c-series-aff220-deploy_image49.png["Tiger3 클러스터에 대해 DRS 및 vSphere HA가 활성화된 새 클러스터 대화 상자의 스크린샷"]
...
+
image:express-c-series-aff220-deploy_image50.png["vSphere 웹 클라이언트의 스크린샷으로, FlexPod 클러스터 작업 메뉴에서 호스트 추가가 선택된 것을 보여줍니다."]
