...
+
image:express-c-series-c190-deploy_image4.png["AutoSupport 및 이벤트 알림 필드가 있는 OnCommand System Manager 지원 설정의 스크린샷"]
...
link:express-c-series-c190-deploy_deploy_cisco_ucs_c-series_rack_server.html["다음으로 Cisco UCS C-Series 랙 서버를 구축합니다."]
