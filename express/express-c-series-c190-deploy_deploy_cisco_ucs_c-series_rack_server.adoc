...
+
image:express-c-series-c190-deploy_image5.png["CIMC 설정을 위해 F8 키를 누르도록 사용자에게 안내하는 Cisco 서버 부팅 화면을 보여주는 스크린샷"]
...
+
image:express-c-series-c190-deploy_image6.png["전용 NIC가 선택되고 이중화가 선택되지 않은 Cisco IMC Configuration Utility NIC 속성 스크린샷"]
...
+
image:express-c-series-c190-deploy_image7.png["Cisco 통합 관리 컨트롤러 BIOS 부팅 순서 구성 페이지의 스크린샷"]
...
+
image:express-c-series-c190-deploy_image8.png["KVM-MAPPED-DVD, iSCSI-A 및 iSCSI-B가 활성화된 고급 부팅 순서 구성의 스크린샷"]
...
+
image:express-c-series-c190-deploy_image9.png["PCIe 슬롯 1과 슬롯 2의 옵션 ROM이 비활성화된 CIMC BIOS 설정을 보여주는 스크린샷"]
...
+
image:express-c-series-c190-deploy_image10.png["포트 채널이 선택 해제된 Cisco Integrated Management Controller 어댑터 카드 MLOM 일반 탭의 스크린샷"]
...
** 업링크 포트를 3으로 설정합니다.
+
image:express-c-series-c190-deploy_image11.png["VLAN 3439 및 업링크 포트 1을 사용하는 iSCSI vNIC eth1의 일반 설정을 보여 주는 스크린샷"]



. 왼쪽에서 vNIC eth1을 선택합니다.
+
image:express-c-series-c190-deploy_image12.png["vNIC eth1에 대한 iSCSI 부팅 속성 이니시에이터 설정을 보여주는 스크린샷"]
...
+
image:express-c-series-c190-deploy_image13.png["이니시에이터, 기본 대상 및 보조 대상 세부 정보가 포함된 iSCSI 부팅 속성 스크린샷"]
...
+
image:express-c-series-c190-deploy_image14.png["이니시에이터 및 타겟 설정을 포함하여 vNIC eth3의 iSCSI 부팅 속성을 보여주는 스크린샷"]
...
+
image:express-c-series-c190-deploy_image15.png["MTU 9000 및 기본 VLAN 2가 설정된 Cisco Integrated Management Controller vNIC eth0 속성의 스크린샷"]

. eth1에 대해 3단계와 4단계를 반복하여 업링크 포트가 eth1에 대해 1로 설정되어 있는지 확인합니다.
+
image:express-c-series-c190-deploy_image16.png["MTU, 업링크 포트 및 VLAN 설정과 함께 eth0부터 eth3까지 나열된 Cisco Integrated Management Controller vNIC의 스크린샷"]
