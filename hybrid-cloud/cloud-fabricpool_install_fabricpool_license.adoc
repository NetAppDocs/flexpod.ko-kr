...
image:cloud-fabricpool_image8.png["Choose Files 및 Add 버튼이 있는 OnCommand System Manager 라이선스 패키지 추가 대화 상자의 스크린샷"]
...
image:cloud-fabricpool_image9.png["FabricPool 라이선스 용량 10 TB 및 현재 용량 0 Byte를 보여주는 ONTAP System Manager 라이선스 상세 정보 스크린샷"]
