...
image:cloud-insights_image2.png["Cisco UCS, Nexus 스위치, NetApp AFF A800 컨트롤러 및 MDS 스위치가 네트워크 링크로 상호 연결된 것을 보여주는 다이어그램"]
...
* NetApp Digital Advisor에 제공된 데이터를 사용하여 스토리지 시스템 위험을 평가하고 스토리지 최적화를 위한 권장 사항을 제시하기 위해 환경을 분석합니다.
