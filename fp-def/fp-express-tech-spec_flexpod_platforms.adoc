...
* *FlexPod Datacenter.* 이 플랫폼은 워크로드 엔터프라이즈 애플리케이션, 가상화, VDI, 퍼블릭 및 프라이빗 클라우드에 적합한 대규모 확장 가능한 가상 데이터 센터 인프라입니다. FlexPod Datacenter는 자체 사양을 가지고 있으며, 이는  https://docs.netapp.com/us-en/flexpod/fp-def/dc-tech-spec_solution_overview.html["FlexPod 데이터 센터 기술 사양"^]에 문서화되어 있습니다.
