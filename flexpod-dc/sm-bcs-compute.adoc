...
image:sm-bcs-image17.png["UCS 2204XP A와 B가 10GBASE-KR을 통해 B200 M5 VIC에 연결된 모습을 보여주는 다이어그램"]
...
image:sm-bcs-image18.png["UCS 5108 IOM이 FI 6454 스위치 및 Nexus A/B 스위치에 연결된 것을 보여주는 다이어그램"]
...
image:sm-bcs-image19.png["두 개의 정적 타겟이 구성된 Cisco UCS Manager iSCSI 부팅 매개변수 설정 대화 상자를 보여주는 스크린샷"]
