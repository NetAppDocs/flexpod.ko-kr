...
image:sm-bcs-image4.png["FlexPod 사이트 A와 B가 최대 10ms의 지연 시간으로 연결되어 있고, 사이트 C에는 ONTAP Mediator가 설치되어 있는 것을 보여주는 다이어그램"]
...
image:sm-bcs-image5.png["Cisco UCS C240/C245, C220/C225, B200 및 X210c M6 서버를 보여주는 다이어그램"]
...
image:sm-bcs-image6.png["UCS 2408, 2304, 2208XP, 2204XP 및 UCSX 9108 모듈의 정면도를 보여주는 다이어그램"]
...
image:sm-bcs-image7.png["Cisco UCS FI 6454, 64108, 6324, 6332 및 6332-16UP 모델의 전면 패널을 보여주는 다이어그램"]
...
image:sm-bcs-image8.png["Cisco UCS VIC 1440, 1467, 1455, 1480, 1477, 1457, 14825, 14425 및 14000 브리지 카드를 보여주는 다이어그램"]
...
image:sm-bcs-image9.png["Cisco Nexus 9336C-FX2, 93180YC-FX3 및 3232C 스위치를 보여주는 다이어그램"]
...
image:sm-bcs-image10.png["Cisco MDS 9132T, 9148T, 9148S, 9250i 및 9396T 스위치의 정면도를 보여주는 다이어그램"]
...
image:sm-bcs-image11.png["NetApp AFF 및 ASA 컨트롤러와 DS 224C/2246 및 NS 224 디스크 셸프를 보여주는 다이어그램"]
...
image:sm-bcs-image12.png["SM-BC 관계를 가진 두 개의 FlexPod 사이트와 사이트 C에 있는 ONTAP Mediator를 보여주는 다이어그램"]
...
image:sm-bcs-image13.png["확장된 레이어 2 링크와 ONTAP Mediator로 연결된 비대칭 FlexPod 사이트를 보여주는 다이어그램"]
...
image:sm-bcs-image14.png["Intersight 및 UCSM에서 관리하는 FlexPod 사이트들이 SM-BC 관계를 통해 VXLAN 다중 사이트 패브릭으로 연결된 모습을 보여주는 다이어그램"]
...
image:sm-bcs-image15.png["FlexPod 지점 사이트가 VXLAN 멀티 사이트 패브릭 및 ONTAP 미디에이터를 통해 데이터 센터에 연결된 방식을 보여주는 다이어그램"]
