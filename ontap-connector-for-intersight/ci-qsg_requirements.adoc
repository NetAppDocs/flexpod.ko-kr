...
NOTE:  https://intersight.com/help/saas/supported_systems/overview["Cisco Intersight 지원 시스템"^]의 Cisco UCS 컴퓨팅 구성 요소 및 UCSM 버전의 최소 요구 사항을 참조하십시오.
...
다양한 라이선스 등급에서 제공하는 기능에 대한 자세한 내용은  https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["인프라 서비스 라이센스"^]을 참조하십시오.
