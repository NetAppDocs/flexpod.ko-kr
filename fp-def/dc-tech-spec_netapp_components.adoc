...
디스크 셸프 및 저장 매체에 대한 자세한 내용은 다음 표의 디스크 셸프 및 저장 매체 기술 사양 링크를 참조하십시오.

|===
| 디스크 쉘프 | 기술 사양 


| DS224C .4+| https://www.netapp.com/data-storage/disk-shelves-storage-media/["디스크 셸프 및 저장 매체 기술 사양"] 
...
| SupportEdge Premium 4시간 현장 - 개월:36 | CS-O2-4시간 | https://www.netapp.com/pdf.html?item=/media/8745-supportedge-premium-product-description.pdf["NetApp SupportEdge Premium를 참조하십시오"^] 
|===